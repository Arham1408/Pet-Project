...
@router.get("/investors/{investor_id}/content", response_model=list[ContentItemResponse])
...
@router.get("/investors/{investor_id}/portfolio", response_model=list[PortfolioChangeResponse])
