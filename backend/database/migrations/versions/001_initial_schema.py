...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("source_type", sa.Enum("sec_13f","website","youtube","rss","twitter","custom", name="source_type", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("investor_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("investors.id", ondelete="CASCADE"), nullable=False),
        sa.Column("content_type", sa.Enum("filing","article","video","newsletter","website_page","custom", name="content_type", create_type=False), nullable=False),
        ...
        sa.Column("processing_status", sa.Enum("pending","processing","completed","failed","skipped", name="processing_status", create_type=False), nullable=False, server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("investor_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("investors.id", ondelete="CASCADE"), nullable=False),
        sa.Column("entity_type", sa.Enum("company","ticker","person","theme","sector","macro_theme", name="entity_type", create_type=False), nullable=False),
        sa.Column("entity_name", sa.String, nullable=False),
        sa.Column("ticker_symbol", sa.String, nullable=True),
        sa.Column("sentiment", sa.Enum("bullish","bearish","neutral","mixed", name="sentiment", create_type=False), nullable=True),
        sa.Column("conviction_level", sa.Enum("high","medium","low","unknown", name="conviction_level", create_type=False), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("change_type", sa.Enum("new_position","increased","decreased","closed","unchanged", name="portfolio_change_type", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("report_type", sa.Enum("investor_report","daily_digest","event_report", name="report_type", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("alert_type", sa.Enum("new_filing","new_company_mention","new_thesis","high_conviction","portfolio_change","daily_digest_ready", name="alert_type", create_type=False), nullable=False),
        sa.Column("title", sa.String, nullable=False),
        sa.Column("summary", sa.Text, nullable=True),
        sa.Column("severity", sa.Enum("low","medium","high","critical", name="alert_severity", create_type=False), nullable=False, server_default="medium"),
